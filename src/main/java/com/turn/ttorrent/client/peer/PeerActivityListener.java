...
public interface PeerActivityListener extends EventListener {
   ...
   *
   * <p>
   * This handler is fired when a peer choked and now refuses to send data to us. This means we
   ...
   *
   * <p>
   * This handler is fired when a peer notified that it is no longer choked. This means we can send
   * piece block requests to it and start downloading.
   * </p>
   *
   ...
   *
   * <p>
   * This handler is fired when an update in piece availability is received from a peer's HAVE
   * message.
   * </p>
   *
   ...
   *
   * <p>
   * This handler is fired when an update in piece availability is received from a peer's BITFIELD
   * message.
   * </p>
   *
   * @param peer            The peer we got the update from.
   ...
   *
   * <p>
   * This handler is fired when a piece has been downloaded entirely and the piece data has been
   * revalidated.
   * </p>
   *
   * <p>
   * <b>Note:</b> the piece may <em>not</em> be valid after it has been downloaded, in which case
   * appropriate action should be taken to redownload the piece.
   * </p>
   *
   * @param peer  The peer we got this piece from.
   * @param piece The piece in question.
   *
   * @throws IOException Unable to handle piece
   */
